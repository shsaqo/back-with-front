        ...
        <div class="col-12">
            <ul class="nav row nav-tabs cystom-tabs" id="myTab" role="tablist">
                <li class="nav-item col-md-6" role="presentation">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Օգտագործման կանոններ</a>
                </li>
                <li class="nav-item col-md-6" role="presentation">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Գաղտնիության քաղաքականությունը</a>
                </li>
